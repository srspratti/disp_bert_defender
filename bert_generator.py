...
#         print("length of ngram_embeddings list: ",len(ngram_embeddings_lst))
        ...
        #ngram_embeddings_ar=np.array(ngram_embeddings_lst, dtype=object)
        ...
        #all_ngram_embeddings = torch.tensor(ngram_embeddings_ar, dtype=torch.float64)
        #all_ngram_embeddings = torch.from_numpy(ngram_embeddings_ar)
        #all_ngram_embeddings = torch.tensor([f.ngram_embeddings for f in train_features], dtype=torch.object)
        #all_ngram_embeddings = torch.from_numpy([f.ngram_embeddings for f in train_features])
