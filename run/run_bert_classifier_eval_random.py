...
dev_attacks.tsv attacks are random ( rand )  
"""
...
command = 'python bert_classifier.py ' \
          ...
          '--do_eval ' \
          '--do_lower_case ' \
          '--data_dir data/sst-2/add_1/enum_attacks_disp/disc_enum_rand_base.tsv ' \
          '--bert_model bert-base-uncased ' \
          '--max_seq_length 64 '\
          '--eval_batch_size 8 ' \
          '--learning_rate 5e-5 '\
          '--output_dir ./tmp/sst2-class/ '\
          '> GAN2vec_RobGAN_data_oup/console_outputs/console_outputs_class_random_dev_attacks.txt '
