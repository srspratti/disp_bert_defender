...
command = 'python bert_discriminator.py  ' \
          ...
          '--data_file ./data/sst-2/add_1/enum_attacks_disp/disc_enum_drop_base.tsv  ' \
          ...
          '--output_dir ./models/  ' \
          '--single' \
          '> GAN2vec_RobGAN_data_oup/console_outputs/console_outputs_discrim_eval_drop_attacks.txt '
