...
command = 'python bert_classifier.py ' \
          ...
          '--do_eval ' \
          '--do_lower_case ' \
          '--data_dir data/sst-2/add_1/enum_attacks_disp/gnrt_eval_outputs_drop.tsv ' \
          ...
          '--attack_type drop ' \
          '> GAN2vec_RobGAN_data_oup/console_outputs/console_outputs_class_drop_recovered.txt '
